<div class="flex space-x-16 max-w-6xl mx-auto mt-120">
    <div class="text-sm text-orange uppercase">El silenci és necessari.<br>Però el soroll, deixa empremta.</div>
    <div class="max-w-3xl">
        <div class="font-semibold text-3xl/tighter">Fer Xivarri és una manera d’expressar inquietuds, de compartir idees, de contrastar opinions. És el que et permet despertar aquella curiositat que, en realitat, mai ha estat adormida. És l’idioma dels que pensen.
        </div>
